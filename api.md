...
- <code title="patch /v2/namespaces/{namespace}/metadata">client.namespaces.<a href="./src/turbopuffer/resources/namespaces.py">update_metadata</a>(\*, namespace, \*\*<a href="src/turbopuffer/types/namespace_update_metadata_params.py">params</a>) -> <a href="./src/turbopuffer/types/namespace_metadata.py">NamespaceMetadata</a></code>
