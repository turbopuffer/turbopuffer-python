...
from turbopuffer import Turbopuffer, AsyncTurbopuffer, DefaultAioHttpClient
from turbopuffer._utils import is_dict
...
logging.getLogger("turbopuffer").setLevel(logging.DEBUG)
...
def client(request: FixtureRequest) -> Iterator[Turbopuffer]:
...
@pytest.fixture(scope="session")
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncTurbopuffer]:
