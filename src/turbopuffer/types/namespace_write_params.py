...
__all__ = ["NamespaceWriteParams", "WriteDocuments", "CopyFromNamespace", "DeleteByFilter"]


class WriteDocuments(TypedDict, total=False):
...
NamespaceWriteParams: TypeAlias = Union[WriteDocuments, CopyFromNamespace, DeleteByFilter]
