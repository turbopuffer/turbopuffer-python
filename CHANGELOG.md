...
## 0.4.0-alpha.2 (2025-05-22)

Full Changelog: [v0.4.0-alpha.1...v0.4.0-alpha.2](https://github.com/turbopuffer/turbopuffer-python/compare/v0.4.0-alpha.1...v0.4.0-alpha.2)
